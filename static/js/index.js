...
var allMusicForPlay = firebase.database().ref('users/jQGwgUqocnOINKzKyb1bNl9y9mF3/random/');
var allMusic = firebase.database().ref('users/jQGwgUqocnOINKzKyb1bNl9y9mF3/music/');
var allCategories = firebase.database().ref('users/jQGwgUqocnOINKzKyb1bNl9y9mF3/category/');
